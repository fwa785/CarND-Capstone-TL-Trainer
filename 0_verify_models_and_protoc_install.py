...
PROTOS_DIR = "../models/object_detection/protos"
...
MODEL_SAVE_DIR_LOC = "../models/object_detection"
FROZEN_INFERENCE_GRAPH_LOC = MODEL_SAVE_DIR_LOC + "/" + MODEL_NAME + "/" + "frozen_inference_graph.pb"
LABEL_MAP_LOC = "../models/object_detection/data/mscoco_label_map.pbtxt"
TEST_IMAGES_DIR = "../models/object_detection/test_images"
...
def main():
    ...
    if StrictVersion(tf.__version__) != StrictVersion('1.3.0'):
        print('error: Please make sure your tensorflow installation to v1.3.0!' + tf.__version__)
        return
    # end if
